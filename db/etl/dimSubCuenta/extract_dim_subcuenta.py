"""
Extraccion Bronze: AS400/LX (PROLX835F.GSV, SVSGMN='SUBCUENTA') -> stg.dimSubCuenta en JAREMAR.
...
WHERE. La estructura de stg.dimSubCuenta se auto-provisiona a partir de la
metadata real de esas columnas en el AS400.

Uso:
    python db/etl/dimSubCuenta/extract_dim_subcuenta.py [--env-file .env]
"""
import argparse
import datetime
import json
...
FILTRO_VALOR = "SUBCUENTA"
STG_ESQUEMA = "stg"
STG_TABLA = "dimSubCuenta"
