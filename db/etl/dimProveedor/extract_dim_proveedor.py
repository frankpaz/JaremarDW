...
descartaron ~110 columnas con 0% o muy baja poblacion (EDI, self-billing,
VMI, campos bancarios/direcciones secundarias de compras poco usados). A
...
COLUMNAS_DESEADAS = [
    ...
    "VTAX", "VTAXCD", "VMIDNM",
    "V1099", "V1099C",
    "VDTLPD", "VPYTYR", "VDPURS",
    "VHOLD", "VNSTAT",
    "VMBANK", "VMBNKC", "VMBRNO", "VMBNKA",
    "VMCARR", "VMMNTR", "VMLANG",
]
...
def cargar_stg(jrm_conn, jrm_cur, columnas: list, filas: list, run_id: int) -> tuple:
    ...
    llave_idx = nombres_cols.index("VENDOR") if "VENDOR" in nombres_cols else None
