...
descartaron ~250 columnas con 0% de uso (EDI, JIT, self-billing, PAB, etc.)
y ~30 columnas de ventas/costo mensual historico (CSL01-12, CCS01-12, CYSAL,
...
COLUMNAS_DESEADAS = [
    ...
    "CRDOL", "CDLIM", "CAPD", "CAIS", "CLAST", "CLPDT", "CLPAM", "CMHOLD",
    "CMDCRT", "CMENDT", "CMENTM", "CMENUS", "CLDTE", "CLTME", "CLUSR",
]
...
def cargar_stg(jrm_conn, jrm_cur, columnas: list, filas: list, run_id: int) -> tuple:
    ...
    llave_idx = nombres_cols.index("CCUST") if "CCUST" in nombres_cols else None
