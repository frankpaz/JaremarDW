"""
Extraccion Bronze: AS400/LX (PROLX835F.GSV, SVSGMN='COMPANIA') -> stg.dimEmpresas en JAREMAR.
...
WHERE. La estructura de stg.dimEmpresas se auto-provisiona a partir de la
metadata real de esas columnas en el AS400.

Uso:
    python db/etl/dimEmpresas/extract_dim_empresas.py [--env-file .env]
"""
import argparse
import datetime
import json
...
FILTRO_VALOR = "COMPANIA"
STG_ESQUEMA = "stg"
STG_TABLA = "dimEmpresas"
