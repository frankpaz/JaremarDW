"""
Extraccion Bronze: AS400/LX (PROLX835F.GSV, SVSGMN='CUENTA') -> stg.dimCuenta en JAREMAR.
...
WHERE. La estructura de stg.dimCuenta se auto-provisiona a partir de la
metadata real de esas columnas en el AS400.

Uso:
    python db/etl/dimCuenta/extract_dim_cuenta.py [--env-file .env]
"""
import argparse
import datetime
import json
