-- 018: merge Silver -> Gold para dimEmpresas. SCD Tipo 1 (sobrescribe).
-- Reutiliza el HashDiff ya calculado en [int].dimEmpresas.
...
BEGIN
    ...
    WHEN NOT MATCHED BY TARGET THEN
        INSERT (CodigoEmpresa, SVID, RazonSocial, FechaRegistro, HoraRegistro, EsVigente, HashDiff, RunId)
