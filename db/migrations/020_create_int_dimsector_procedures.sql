-- 020: merge Bronze -> Silver para dimSector.

CREATE OR ALTER PROCEDURE [int].usp_MergeDimSector
    @RunId INT
AS
BEGIN
    SET NOCOUNT ON;

    DECLARE @FilasLeidas INT = (SELECT COUNT(*) FROM stg.dimSector);
    ...
    MERGE [int].dimSector AS destino
