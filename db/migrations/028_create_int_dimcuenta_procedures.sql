-- 028: merge Bronze -> Silver para dimCuenta.

CREATE OR ALTER PROCEDURE [int].usp_MergeDimCuenta
    @RunId INT
AS
BEGIN
    SET NOCOUNT ON;

    DECLARE @FilasLeidas INT = (SELECT COUNT(*) FROM stg.dimCuenta);
    ...
    MERGE [int].dimCuenta AS destino
