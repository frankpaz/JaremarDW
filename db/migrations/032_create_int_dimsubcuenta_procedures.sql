-- 032: merge Bronze -> Silver para dimSubCuenta.

CREATE OR ALTER PROCEDURE [int].usp_MergeDimSubCuenta
    @RunId INT
AS
BEGIN
    SET NOCOUNT ON;

    DECLARE @FilasLeidas INT = (SELECT COUNT(*) FROM stg.dimSubCuenta);
    ...
    MERGE [int].dimSubCuenta AS destino
